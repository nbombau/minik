...
bash(char *line  )
{
    ...
    case IMPRIME4EVER_BK:
		...
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
		CrearProceso ("ImprimeLetra", ImprimeLetras4Ever, 0, (char **)0, DEF_PRIO, TRUE, DEF_STACKSIZE);
